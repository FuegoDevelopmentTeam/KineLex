...
- **Automatikus Verzióemelés (Semantic Versioning):** Valahányszor a User jóváhagy egy új táncelméleti szabályt, elnevezési stratégiát vagy ontológiai átrendezést, és te ezt átvezeted a `MASTER_CONCEPT.md` fájlba, **kötelezően és automatikusan frissítened kell a dokumentum fejlécében található verziószámot**.
  ...
  - A válaszod végén mindig jelezd egyértelműen a Usernek: *"A MASTER_CONCEPT.md verziószámát vX.Y.Z-re emeltem."*
